...
public class CustomerControllerTest {
   ...
   CustomerService customerservice;
    ...
    public void getCustomerById_success() throws Exception {
        Mockito.when(this.customerservice.getCustomerById(Customer_1.getId())).thenReturn(java.util.Optional.of(Customer_1));
    ...
    public void getAllCustomers_success() throws Exception {
        ...
        Mockito.when(customerservice.getAll()).thenReturn(records);
    ...
    public void getCustomerById_InvalidID() throws Exception {
    	Optional<Customer> customerData = customerservice.getCustomerById(5l);
        Mockito.when(customerservice.getCustomerById(5l)).thenReturn(customerData);
        mockMvc.perform(MockMvcRequestBuilders
    ...
    public void postCustomer_success() throws Exception {
        ...
        Mockito.when(customerservice.add(record)).thenReturn(record);
    ...
    public void postCustomer_failure() throws Exception {
        ...
        Mockito.when(this.customerservice.add(record)).thenReturn(null);
    ...
    public void putCustomer_success() throws Exception {
        ...
        Mockito.when(customerservice.update(updatedRecord)).thenReturn(updatedRecord);
...
/*    //b. Checking if not found status is sent if incorrect id is given.
    ...
    public void putCustomer_recordNotFound() throws Exception {
       ...
       Mockito.when(customerservice.update(updatedRecord)).thenReturn(throw new Exception());
    ...
    public void deleteCustomerById_success() throws Exception {
        Mockito.when(customerservice.delete(Customer_2.getId())).thenReturn(Customer_2);
   ...
   @Test
    public void deleteCustomerById_notFound() throws Exception {
        Mockito.when(customerservice.delete(5l)).thenReturn(null);
